			...
			for(int i=0;i<totalPlayTime;i++){
				...
				display.getDefault().asyncExec(new Runnable() {//这个是同步主线程的资源而不发生异常
					public void run() {
						...
						System.out.println((int)((autoAddprogressBarTime+0.00)/totalPlayTime*100));
